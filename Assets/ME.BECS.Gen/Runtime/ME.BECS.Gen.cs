namespace ME.BECS {
    ...
    public static unsafe class StaticMethods {
        ...
        public static void SystemsLoad() {
            // Graph: Smesharix-FeaturesGraph
            {
                SystemsStatic.RegisterMethod(GraphGraphSmesharix_FeaturesGraphInitialize.GraphInitialize_1001_SystemsCodeGenerator, 1001, false);
                SystemsStatic.RegisterAwakeMethod(GraphGraphSmesharix_FeaturesGraphAwake.GraphOnAwake_1001_SystemsCodeGenerator, 1001, false);
                SystemsStatic.RegisterStartMethod(GraphGraphSmesharix_FeaturesGraphStart.GraphOnStart_1001_SystemsCodeGenerator, 1001, false);
                SystemsStatic.RegisterUpdateMethod(GraphGraphSmesharix_FeaturesGraphUpdate.GraphOnUpdate_1001_SystemsCodeGenerator, 1001, false);
                SystemsStatic.RegisterDrawGizmosMethod(GraphGraphSmesharix_FeaturesGraphDrawGizmos.GraphOnDrawGizmos_1001_SystemsCodeGenerator, 1001, false);
                SystemsStatic.RegisterDestroyMethod(GraphGraphSmesharix_FeaturesGraphDestroy.GraphOnDestroy_1001_SystemsCodeGenerator, 1001, false);
                SystemsStatic.RegisterGetSystemMethod(GraphGraphSmesharix_FeaturesGraphInitialize.GraphGetSystem_1001_SystemsCodeGenerator, 1001, false);
            }
            // Graph: Smesharix-VisualGraph
            {
                SystemsStatic.RegisterMethod(GraphGraphSmesharix_VisualGraphInitialize.GraphInitialize_1002_SystemsCodeGenerator, 1002, false);
                SystemsStatic.RegisterAwakeMethod(GraphGraphSmesharix_VisualGraphAwake.GraphOnAwake_1002_SystemsCodeGenerator, 1002, false);
                SystemsStatic.RegisterStartMethod(GraphGraphSmesharix_VisualGraphStart.GraphOnStart_1002_SystemsCodeGenerator, 1002, false);
                SystemsStatic.RegisterUpdateMethod(GraphGraphSmesharix_VisualGraphUpdate.GraphOnUpdate_1002_SystemsCodeGenerator, 1002, false);
                SystemsStatic.RegisterDrawGizmosMethod(GraphGraphSmesharix_VisualGraphDrawGizmos.GraphOnDrawGizmos_1002_SystemsCodeGenerator, 1002, false);
                SystemsStatic.RegisterDestroyMethod(GraphGraphSmesharix_VisualGraphDestroy.GraphOnDestroy_1002_SystemsCodeGenerator, 1002, false);
                SystemsStatic.RegisterGetSystemMethod(GraphGraphSmesharix_VisualGraphInitialize.GraphGetSystem_1002_SystemsCodeGenerator, 1002, false);
            }
        }
