    ...
    public static unsafe class DebugJobsFunc {
        ...
        public static void InitializeJobsDebug() {
            ...
            { // ME.BECS.Units.HitSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Units.HitSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData19Unsafe) : typeof(JobDebugData19));
            }
            { // ME.BECS.Views.Jobs+JobAddToScene
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Views.Jobs.JobAddToScene>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData20Unsafe) : typeof(JobDebugData20));
            }
            { // ME.BECS.Views.Jobs+JobAssignViews
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Views.Jobs.JobAssignViews>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData21Unsafe) : typeof(JobDebugData21));
            }
            { // ME.BECS.Views.Jobs+JobRemoveFromScene
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Views.Jobs.JobRemoveFromScene>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData22Unsafe) : typeof(JobDebugData22));
            }
            { // ME.BECS.Attack.CanFireSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.CanFireSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData23Unsafe) : typeof(JobDebugData23));
            }
            { // ME.BECS.Attack.ChangeAttackTargetFromShadowCopySystem+TargetJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.ChangeAttackTargetFromShadowCopySystem.TargetJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData24Unsafe) : typeof(JobDebugData24));
            }
            { // ME.BECS.Attack.ChangeAttackTargetFromShadowCopySystem+TargetsJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.ChangeAttackTargetFromShadowCopySystem.TargetsJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData25Unsafe) : typeof(JobDebugData25));
            }
            { // ME.BECS.Attack.FireSystem+FireTargetJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.FireSystem.FireTargetJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData26Unsafe) : typeof(JobDebugData26));
            }
            { // ME.BECS.Attack.FireSystem+FireTargetsJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.FireSystem.FireTargetsJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData27Unsafe) : typeof(JobDebugData27));
            }
            { // ME.BECS.Attack.ReloadSystem+ReloadJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.ReloadSystem.ReloadJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData28Unsafe) : typeof(JobDebugData28));
            }
            { // ME.BECS.Attack.ResetCanFireSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.ResetCanFireSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData29Unsafe) : typeof(JobDebugData29));
            }
            { // ME.BECS.Attack.RotateWhileAttackSystem+IdleJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.RotateWhileAttackSystem.IdleJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData30Unsafe) : typeof(JobDebugData30));
            }
            ...
            { // ME.BECS.Attack.SearchTargetSystem+SearchTargetJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.SearchTargetSystem.SearchTargetJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData32Unsafe) : typeof(JobDebugData32));
            }
            { // ME.BECS.Attack.StopWhileAttackSystem+JobRemove
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.StopWhileAttackSystem.JobRemove>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData33Unsafe) : typeof(JobDebugData33));
            }
            { // ME.BECS.Attack.StopWhileAttackSystem+JobRotate
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.StopWhileAttackSystem.JobRotate>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData34Unsafe) : typeof(JobDebugData34));
            }
            { // ME.BECS.Bullets.DestroySystem+DestroyJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Bullets.DestroySystem.DestroyJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData35Unsafe) : typeof(JobDebugData35));
            }
            { // ME.BECS.Bullets.FlySystem+FlyJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Bullets.FlySystem.FlyJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData36Unsafe) : typeof(JobDebugData36));
            }
            { // ME.BECS.Commands.CommandAttackSystem+CleanUpJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Commands.CommandAttackSystem.CleanUpJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData37Unsafe) : typeof(JobDebugData37));
            }
            { // ME.BECS.Commands.CommandAttackSystem+MoveJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Commands.CommandAttackSystem.MoveJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData38Unsafe) : typeof(JobDebugData38));
            }
            { // ME.BECS.Commands.CommandBuildSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Commands.CommandBuildSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData39Unsafe) : typeof(JobDebugData39));
            }
            { // ME.BECS.Commands.CommandMoveSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Commands.CommandMoveSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData40Unsafe) : typeof(JobDebugData40));
            }
            { // ME.BECS.FogOfWar.CreateSystem+CleanUpJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.FogOfWar.CreateSystem.CleanUpJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData41Unsafe) : typeof(JobDebugData41));
            }
            { // ME.BECS.FogOfWar.CreateSystem+CreateJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.FogOfWar.CreateSystem.CreateJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData42Unsafe) : typeof(JobDebugData42));
            }
            { // ME.BECS.Pathfinding.FollowPathSystem+PathFollowJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Pathfinding.FollowPathSystem.PathFollowJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData43Unsafe) : typeof(JobDebugData43));
            }
            { // ME.BECS.Pathfinding.FollowPathSystem+SpeedDownOnHoldJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Pathfinding.FollowPathSystem.SpeedDownOnHoldJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData44Unsafe) : typeof(JobDebugData44));
            }
            { // ME.BECS.Pathfinding.FollowPathWithAvoidanceSystem+PathFollowJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Pathfinding.FollowPathWithAvoidanceSystem.PathFollowJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData45Unsafe) : typeof(JobDebugData45));
            }
            { // ME.BECS.Pathfinding.FollowPathWithAvoidanceSystem+SpeedDownOnHoldJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Pathfinding.FollowPathWithAvoidanceSystem.SpeedDownOnHoldJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData46Unsafe) : typeof(JobDebugData46));
            }
            { // ME.BECS.Pathfinding.LookAtSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Pathfinding.LookAtSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData47Unsafe) : typeof(JobDebugData47));
            }
            { // ME.BECS.QuadTreeInsertSystem+CollectJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.QuadTreeInsertSystem.CollectJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData48Unsafe) : typeof(JobDebugData48));
            }
            { // ME.BECS.QuadTreeInsertSystem+CollectRectJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.QuadTreeInsertSystem.CollectRectJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData49Unsafe) : typeof(JobDebugData49));
            }
            { // ME.BECS.QuadTreeQuerySystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.QuadTreeQuerySystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData50Unsafe) : typeof(JobDebugData50));
            }
            { // ME.BECS.Transforms.TransformWorldMatrixUpdateSystem+CalculateJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Transforms.TransformWorldMatrixUpdateSystem.CalculateJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData51Unsafe) : typeof(JobDebugData51));
            }
            { // ME.BECS.Transforms.TransformWorldMatrixUpdateSystem+CalculateLocalMatrixJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Transforms.TransformWorldMatrixUpdateSystem.CalculateLocalMatrixJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData52Unsafe) : typeof(JobDebugData52));
            }
            { // ME.BECS.Transforms.TransformWorldMatrixUpdateSystem+CalculateRootsJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Transforms.TransformWorldMatrixUpdateSystem.CalculateRootsJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData53Unsafe) : typeof(JobDebugData53));
            }
            { // ME.BECS.Transforms.TransformWorldMatrixUpdateSystem+ClearJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Transforms.TransformWorldMatrixUpdateSystem.ClearJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData54Unsafe) : typeof(JobDebugData54));
            }
            { // ME.BECS.Units.DestroySystem+DestroyJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Units.DestroySystem.DestroyJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData55Unsafe) : typeof(JobDebugData55));
            }
            { // ME.BECS.Units.SteeringSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Units.SteeringSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData56Unsafe) : typeof(JobDebugData56));
            }
            { // ME.BECS.Units.SteeringWithAvoidanceSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Units.SteeringWithAvoidanceSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData57Unsafe) : typeof(JobDebugData57));
            }
            { // ME.BECS.UnitsHealthBars.DrawHealthBarsSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.UnitsHealthBars.DrawHealthBarsSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData58Unsafe) : typeof(JobDebugData58));
            }
            { // ME.BECS.Attack.MoveToAttackerSystem+MoveToAttackerJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.MoveToAttackerSystem.MoveToAttackerJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData59Unsafe) : typeof(JobDebugData59));
            }
            { // ME.BECS.Attack.MoveToAttackerSystem+StopOnTargetJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.MoveToAttackerSystem.StopOnTargetJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData60Unsafe) : typeof(JobDebugData60));
            }
            { // ME.BECS.Attack.MoveToAttackerSystem+UpdatePathJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.MoveToAttackerSystem.UpdatePathJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData61Unsafe) : typeof(JobDebugData61));
            }
            { // ME.BECS.Attack.SearchTargetSystem+SearchTargetsJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.SearchTargetSystem.SearchTargetsJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData62Unsafe) : typeof(JobDebugData62));
            }
            { // ME.BECS.Attack.StopWhileAttackSystem+JobSet
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Attack.StopWhileAttackSystem.JobSet>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData63Unsafe) : typeof(JobDebugData63));
            }
            { // ME.BECS.FogOfWar.QuadTreeQueryFogOfWarSystem+Job
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.FogOfWar.QuadTreeQueryFogOfWarSystem.Job>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData64Unsafe) : typeof(JobDebugData64));
            }
            { // ME.BECS.Transforms.TransformWorldMatrixUpdateSystem+CalculateRootsWithChildrenJob
                ...
                var fn = BurstCompiler.CompileFunctionPointer<CompiledJobCallback>(Method);
                CompiledJobs<ME.BECS.Transforms.TransformWorldMatrixUpdateSystem.CalculateRootsWithChildrenJob>.SetFunction(fn, (unsafeMode) => unsafeMode == true ? typeof(JobDebugData65Unsafe) : typeof(JobDebugData65));
            }
        }
        #endif
